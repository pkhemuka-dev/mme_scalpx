...
def _batch26d_required_common_surface(container, key, *, family="MIST", source="unknown"):
    """
...
def extract_provider_runtime(view: Mapping[str, Any]) -> dict[str, Any]:
    return as_mapping(_batch26d_required_common_surface(view, "provider_runtime", family="MIST", source="view"))
...
def selected_option(view: Mapping[str, Any], branch_id: str) -> dict[str, Any]:
    ...
    selected = as_mapping(_batch26d_required_common_surface(common, "selected_option", family="MIST", source="common"))
...
_BATCH26_OI_C_FAMILY_ID = "MIST"
_BATCH26_OI_C_SOFT_POLICY = "pullback_resume_quality_context_only"
_BATCH26_OI_C_SOFT_POLICY_DESCRIPTION = "MIST uses OI wall only as pullback/resume quality context."
