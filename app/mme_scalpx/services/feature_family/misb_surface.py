...
_BATCH9_FAMILY_LC = "misb"
_BATCH9_FAMILY_ID = "MISB"
_BATCH9_ALLOWED_BRANCH_IDS = (N.BRANCH_CALL, N.BRANCH_PUT)

_BATCH9_ORIGINAL_BRANCH_BUILDER = build_misb_branch_surface
_BATCH9_ORIGINAL_FAMILY_BUILDER = build_misb_family_surface
...
def build_misb_branch_surface(*args: Any, **kwargs: Any) -> dict[str, Any]:
...
def build_misb_family_surface(*args: Any, **kwargs: Any) -> dict[str, Any]:
