...
# =============================================================================
# Batch 17 freeze hardening: provider/family/time/firewall field extension
# =============================================================================

_BATCH17_RESEARCH_CONTRACT_EXTENSION_VERSION = "1"

_BATCH17_EXTRA_FIELD_SPECS: tuple[FieldSpec, ...] = (
    # Event-time identity
    _field(
        name="ts_event_ns",
        dtype="int",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.TIMING_IDENTITY,
        description="Canonical market event timestamp in nanoseconds when available.",
    ),
    _field(
        name="ts_exchange_ns",
        dtype="int",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.TIMING_IDENTITY,
        description="Exchange-origin timestamp in nanoseconds when provided by source.",
    ),
    _field(
        name="ts_broker_ns",
        dtype="int",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.TIMING_IDENTITY,
        description="Broker/provider-origin timestamp in nanoseconds when available.",
    ),
    _field(
        name="ts_capture_ns",
        dtype="int",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.TIMING_IDENTITY,
        description="Research capture timestamp in nanoseconds.",
    ),
    _field(
        name="ts_archive_write_ns",
        dtype="int",
        source=RC,
        requiredness=OPT,
        compute_stage=RAW,
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.TIMING_IDENTITY,
        description="Archive writer timestamp in nanoseconds, added only by archive layer.",
    ),
    _field(
        name="clock_source",
        dtype="str",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.TIMING_IDENTITY,
        description="Clock source used for event/capture/archive timestamp fields.",
    ),

    # Provider/instrument equivalence
    _field(
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Source provider identity, e.g. ZERODHA or DHAN.",
    ),
    _field(
        name="source_provider_token",
        dtype="str_or_int",
        source=BR,
        requiredness=REC,
        compute_stage=RAW,
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Provider-native token or security id from raw source.",
    ),
    _field(
        name="canonical_instrument_key",
        dtype="str",
        source=SR,
        requiredness=REC,
        compute_stage=RAW,
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Canonical cross-provider instrument key used by MME.",
    ),
    _field(
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Zerodha-native instrument token, preserved separately from Dhan security id.",
    ),
    _field(
        name="dhan_security_id",
        dtype="str_or_int",
        source=SR,
        requiredness=OPT,
        compute_stage=RAW,
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Dhan-native security_id, preserved separately from Zerodha token.",
    ),
    _field(
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Provider-token equivalence status for this instrument snapshot.",
    ),
    _field(
        name="option_symbol",
        dtype="str",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Execution/display option symbol when applicable.",
    ),
    _field(
        name="option_token",
        dtype="str_or_int",
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.INSTRUMENT_IDENTITY,
        description="Execution/provider option token when applicable.",
    ),
    _field(
        ...
        layer=FieldLayer.RAW_RECOMMENDED,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="JSON-encoded raw source payload for unknown broker fields and forensic preservation.",
    ),

    # Five-family/provider-aware audit context
    _field(
        name="strategy_family_id",
        dtype="str",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="MME strategy family id captured for audit only.",
    ),
    _field(
        name="doctrine_id",
        dtype="str",
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Doctrine id captured for audit only.",
    ),
    _field(
        name="branch_id",
        dtype="str",
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="CALL/PUT branch id captured for audit only.",
    ),
    _field(
        name="action",
        dtype="str",
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Strategy/action audit literal; not production approval.",
    ),
    _field(
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Candidate score captured for replay/research audit.",
    ),
    _field(
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Candidate priority captured for replay/research audit.",
    ),
    _field(
        name="blocked_reason",
        dtype="str",
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Blocked reason captured for audit.",
    ),
    _field(
        name="provider_ready_classic",
        dtype="bool",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Classic-four provider readiness flag captured for audit.",
    ),
    _field(
        name="provider_ready_miso",
        dtype="bool",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="MISO provider readiness flag captured for audit.",
    ),
    _field(
        name="dhan_context_status",
        dtype="str",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Dhan context status captured for research/replay.",
    ),
    _field(
        name="miso_context_ready",
        dtype="bool",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="MISO context readiness captured for audit.",
    ),
    _field(
        name="payload_json",
        dtype="str",
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="JSON strategy/runtime payload captured for forensic replay.",
    ),
    _field(
        name="family_features_json",
        dtype="str",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="JSON family_features payload captured for audit.",
    ),
    _field(
        name="family_surfaces_json",
        dtype="str",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="JSON family_surfaces payload captured for audit.",
    ),
    _field(
        name="family_frames_json",
        dtype="str",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="JSON family_frames payload captured for audit.",
    ),

    # Research firewall flags
    _field(
        name="production_doctrine_mutated",
        dtype="bool",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        usage_class=AUD,
        storage_targets=(AP, MJ),
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Must remain false: research capture cannot mutate production doctrine.",
    ),
    _field(
        name="production_params_mutated",
        dtype="bool",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Must remain false: research capture cannot mutate production params.",
    ),
    _field(
        name="live_runtime_mutated",
        dtype="bool",
        source=SA,
        requiredness=OPT,
        compute_stage=LIVE,
        ...
        layer=FieldLayer.AUDIT_RUNTIME_FORENSICS,
        group=FieldGroup.AUDIT_RUNTIME_FORENSICS,
        description="Must remain false: research capture cannot mutate live runtime.",
    ),
)

_existing_names = {spec.name for spec in FIELD_SPECS}
_missing_batch17_specs = tuple(spec for spec in _BATCH17_EXTRA_FIELD_SPECS if spec.name not in _existing_names)
if _missing_batch17_specs:
    FIELD_SPECS = tuple(FIELD_SPECS) + _missing_batch17_specs
    FIELD_NAMES = tuple(spec.name for spec in FIELD_SPECS)
    FIELD_SPECS_BY_NAME = MappingProxyType({spec.name: spec for spec in FIELD_SPECS})


def batch17_required_field_names() -> tuple[str, ...]:
    return tuple(spec.name for spec in _BATCH17_EXTRA_FIELD_SPECS)


def research_capture_production_firewall() -> dict[str, bool]:
    return {
