...
Invalid target:
- bin/proofs/proof_feature_family_strategy_surfaces.py
...
MESSAGE = (
    "DISABLED: bin/proof_feature_family_strategy_surfaces.py is excluded from automated bin/proofs migration. "
