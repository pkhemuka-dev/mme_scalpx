...
- Old Friday durable had candidate rows but identity_rows=0, so old durable cannot prove identity.
...
## Next batch after market starts
Run observe-only live-shadow rehearsal, then R34O verify fresh symbol/token candidate truth.
