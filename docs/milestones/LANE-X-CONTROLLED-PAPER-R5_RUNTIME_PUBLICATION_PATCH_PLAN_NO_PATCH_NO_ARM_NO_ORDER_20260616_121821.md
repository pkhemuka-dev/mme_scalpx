...
```json
{
  "classification": "PASS_CONTROLLED_PAPER_R5_PATCH_PLAN_WRITTEN_NO_PATCH_NO_ARM_NO_ORDER",
  ...
  "no_risk_start": true,
  "paper_gate_logic_exists": true,
  "paper_trial_decision": "NOT_READY_TO_ARM",
  "r4_classification": "PASS_CONTROLLED_PAPER_R4_SOURCE_WRITERS_EXIST_RUNTIME_PUBLICATION_MISSING_NO_ARM_NO_ORDER",
  "required_next_action": "After-market patch/harness to publish fail-closed position/risk/execution/paper-gate status, then rerun gate verdict.",
  "runtime_publication_missing": true,
  "source_from_r4": "run/proofs/LANE-X-CONTROLLED-PAPER-R4_STATE_WRITER_OWNER_LOCATOR_NO_PATCH_NO_ARM_NO_ORDER_20260616_113747_proof.json",
  "source_writers_exist": true,
  "tag": "LANE-X-CONTROLLED-PAPER-R5_RUNTIME_PUBLICATION_PATCH_PLAN_NO_PATCH_NO_ARM_NO_ORDER_20260616_121821"
}
```
...
app/mme_scalpx/integrations/broker
```
