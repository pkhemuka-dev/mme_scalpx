# Batch 30F-R2 — Lane C Artifact Mapping + Dataset Selection

Verdict: FAIL_STOP_AND_DIAGNOSE

Health: FAIL_STOP_AND_DIAGNOSE

Blockers: ["EXECUTION_LOCK_ABSENT_BLOCKER"]
...
```json
{
  ...
  "decision_like": [
    ...
    "run/replay/replay_shadow_single_day_phasea3_shadow_true_cmp_20260418_132241_2cacf973/artifacts/strategy_decisions.json",
    "run/replay/replay_locked_single_day_scope_fix_check_4_20260418_104818_3fd0cf39/artifacts/strategy_decisions.json",
  ...
  "frame_like": [
    ...
    "run/replay/true_cmp_frames_20260418_182835/shadow_frames.json",
    ...
    "run/replay/phasea1_true_comparison_20260418_184652/profile_snapshot.json",
    "run/replay/_phase_a4_replay_compare_insufficiency_check/profile_snapshot.json"
  ],
  "json_count": 2008,
  "manifest_inspection": [
    {
  ...
  "replay_like": [
    ...
    "run/replay/replay_experiment_parameter_sweep_87afd861a2ee43c9/experiments/08_experiment_comparison_export.json",
    "run/replay/raw_t_post_raw_s_replay_rerun_20260501_151908_raw_s_export/enriched_replay_records.jsonl",
    "run/replay/phasea1_true_comparison_20260418_184652/21_comparison_summary.csv",
    "run/replay/phasea1_true_comparison_20260418_184652/06_blocker_diff_report.json",
    "run/replay/phasea1_true_comparison_20260418_184652/20_comparison_summary.json"
  ],
  "sample_files": [
    "batch24_broad_replay_materialized_events.jsonl",
    "batch23_strong_replay_sample_events.jsonl",
    "_phase_a4_closure_proof.json",
    "_phase_a4_true_owner_rerun_inputs.json",
    "batch22_aftermarket_semantic_replay_events.jsonl",
    "raw_o_label_enriched_20260501_142509/label_enrichment_manifest.json",
    "raw_o_label_enriched_20260501_142509/label_enriched_replay_records.jsonl",
    "raw_o_label_enriched_20260501_142509/label_enrichment_summary.json",
    "_phase_a4_row_context_overlay_real_check/baseline_frames.json",
    "_phase_a4_row_context_overlay_real_check/shadow_frames.json",
    "frame_export_smoke/baseline_frames.json",
    "frame_export_smoke/shadow_frames.json",
    "frame_export_smoke/comparison_output/12_operator_verdict.txt",
    "frame_export_smoke/comparison_output/06_blocker_diff_report.json",
    "frame_export_smoke/comparison_output/09_put_leg_focus_report.json",
    "frame_export_smoke/comparison_output/04_metrics_summary.json",
    "frame_export_smoke/comparison_output/shadow_override_flattened.json",
    "frame_export_smoke/comparison_output/08_side_split_report.json",
    "frame_export_smoke/comparison_output/07_economics_diff_report.json",
    "frame_export_smoke/comparison_output/05_candidate_diff_report.json",
    "frame_export_smoke/comparison_output/11_differential_report.json",
    "frame_export_smoke/comparison_output/profile_snapshot.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/00_manifest.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/02_scope_profile.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/04_metrics_summary.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/03_integrity_report.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/01_dataset_summary.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/17_effective_inputs.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/18_effective_overrides_flat.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/artifacts/10_run_summary.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/artifacts/strategy_decisions.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/artifacts/risk_outputs.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/artifacts/engine_result.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/artifacts/features_rows.json",
    "replay_locked_single_day_phasea1_features_check_20260418_131311_8f8617ae/artifacts/11_run_summary.csv",
    "raw_q_trade_family_backfill_20260501_143325/trade_family_backfilled_records.jsonl",
    "raw_q_trade_family_backfill_20260501_143325/trade_family_backfill_manifest.json",
    "raw_q_trade_family_backfill_20260501_143325/trade_family_backfill_summary.json",
    "replay_locked_single_day_phasea3_economics_check_20260418_132232_a6215458/00_manifest.json",
    "replay_locked_single_day_phasea3_economics_check_20260418_132232_a6215458/02_scope_profile.json"
  ],
  "score": 110,
  "summary_inspection": [
    {
...
Next: Fix Lane-C artifact mapping blockers before dataset validation.

Safety: no patch, no service start/stop, no Redis restart, no paper/live, no orders, no replay execution, no dataset materialization.
