# REPLAY-DATA-A76 offline fill-bearing dataset build contract + guarded builder plan only

{
  "a77_preview_path": "run/replay/a76_fill_build_contract/20260510T153802Z/A77_OFFLINE_FILL_DATASET_BUILDER_PREVIEW_DO_NOT_RUN.sh",
  "advisories": [
    "A76 wrote only a dataset-build contract and A77 preview placeholder.",
    "A76 did not build the fill-bearing dataset and did not run replay/economics/backtest.",
    "Next valid batch is A77 guarded offline simulated-fill dataset builder, still not full-system/economics."
  ],
  "backup_dir": "run/_code_backups/replay_data_a76_fill_build_contract_20260510T153802Z",
  "batch": "REPLAY-DATA-A76",
  "blocker_count": 0,
  "blockers": [],
  "broker_calls_executed": false,
  "classification": "FILL_BUILD_CONTRACT_READY_FOR_A77_GUARDED_BUILDER_FULL_SYSTEM_ECONOMICS_STILL_BLOCKED",
  ...
  "next_batch": "REPLAY-DATA-A77 guarded offline simulated-fill dataset builder only",
  "orders_sent": false,
  "paper_armed_approved": false,
  "paper_or_live_enabled": false,
  "risk_row_count": 33130,
  "selected_input_day_dir": "run/replay/parity/offline_materialization/session_exports_canonical_candidate_20260417_a7_20260508T173739Z_cleaned_selected_day_a29_20260508T194132Z/2026-04-17",
  "source_a75": "run/proofs/proof_replay_data_a75_fill_dataset_build_route_audit_20260510T153619Z.json",
  "source_profiles": {
  ...
  "verdict": "PASS_A76_FILL_BUILD_CONTRACT_GUARDED_PLAN_NO_EXECUTION",
  "warning_count": 0,
  "warnings": []
}
