# A6-FEED-R5V_read_only_strategy_log_and_feature_consumer_gate_inspection_after_decisions_stale_no_patch_no_restart_no_order_no_paper_20260515_101719
...
```json
{
  ...
  "decisions_stream_age_ms": 1488768,
  "decisions_stream_xlen": 1684,
  "features_stream_age_ms": 10198,
  ...
  "inspection": {
    ...
    "features_process_visible": true,
    "features_recent": true,
    "strategy_pids": [
      "2981"
    ],
    "strategy_process_visible": true
  },
  "likely_condition": "STRATEGY_RUNNING_FEATURES_RECENT_BUT_DECISION_PUBLISH_GATE_BLOCKED_OR_LOOP_IDLE",
  "lock_keys": [],
  "next_action": "Inspect strategy log/source gate result for feature consumer/publish condition; no restart/paper/live.",
...
Proof:
- /home/Lenovo/scalpx/projects/mme_scalpx/run/proofs/A6-FEED-R5V_read_only_strategy_log_and_feature_consumer_gate_inspection_after_decisions_stale_no_patch_no_restart_no_order_no_paper_20260515_101719.json
