# A6-FEED-R5Q-R2_corrected_read_only_extended_feed_feature_decision_readiness_consolidation_fixed_redaction_no_patch_no_restart_no_order_no_paper_20260514_140055
...
```json
{
  ...
  "readiness_failures": [
    ...
    "dhan_option_context_stream_recent",
...
```json
{
  ...
  "dhan_option_context_stream_recent": false,
...
Proof:
- /home/Lenovo/scalpx/projects/mme_scalpx/run/proofs/A6-FEED-R5Q-R2_corrected_read_only_extended_feed_feature_decision_readiness_consolidation_fixed_redaction_no_patch_no_restart_no_order_no_paper_20260514_140055.json
