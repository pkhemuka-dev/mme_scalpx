# REPLAY-DATA-A64-R7 topology-source repair artifact audit only

{
  ...
  "batch": "REPLAY-DATA-A64-R7",
  "blocker_count": 0,
  "blockers": [],
  "broker_calls_executed": false,
  "candidate_count": 0,
  "classification": "PASS_A64_RISK_SCOPE_COMPLETED_READY_FOR_A65_PRECHECK",
  "command_executed": false,
  "economics_pnl_evaluation_allowed": false,
  "engine_result_topology_missing": true,
  ...
  "next_batch": "REPLAY-DATA-A65 artifact audit + execution-shadow scope precheck",
  "orders_sent": false,
  ...
  "source_a64_r5": "run/proofs/proof_replay_data_a64_r5_nested_artifact_audit_20260510T141024Z.json",
  "strategy_action_breakdown": {
    "HOLD": 165650
  },
  "strategy_row_count": 165650,
  "trade_count": 0,
  "verdict": "PASS_A64_TOPOLOGY_SOURCE_REPAIR_ARTIFACT_AUDIT",
  "warning_count": 3,
  "warnings": [
    "run_summary integrity_verdict is not pass; carry forward to A65 precheck",
    "ml_export_eligible is not true; expected for quote-only/non-economics scope",
    "engine_result topology fields missing; accepted run_summary as authoritative topology source for A64 artifact audit"
  ]
}
