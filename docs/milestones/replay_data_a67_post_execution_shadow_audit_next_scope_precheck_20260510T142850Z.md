# REPLAY-DATA-A67 post-execution-shadow artifact audit + next-scope block precheck

{
  ...
  "batch": "REPLAY-DATA-A67",
  "blocker_count": 0,
  "blockers": [],
  "broker_calls_executed": false,
  "candidate_count": 0,
  "classification": "PASS_A67_EXECUTION_SHADOW_CHAIN_COMPLETE_FULL_SYSTEM_ECONOMICS_STILL_BLOCKED",
  ...
  "next_batch": "STOP_OR_EXPLICIT_NEXT_SCOPE_APPROVAL_REQUIRED_FULL_SYSTEM_AND_ECONOMICS_REMAIN_BLOCKED",
  "orders_sent": false,
  ...
  "source_a66_r2": "run/proofs/proof_replay_data_a66_r2_completion_monitor_20260510T142713Z.json",
  "strategy_action_breakdown": {
    "HOLD": 165650
  },
  "strategy_row_count": 165650,
  "trade_count": 0,
  "verdict": "PASS_A67_POST_EXECUTION_SHADOW_ARTIFACT_AUDIT",
  "warning_count": 1,
  "warnings": [
    "A66 integrity verdict is not pass: fail; accepted only for post-shadow audit, not for full-system/economics promotion."
  ]
}
